    ...
    public class Delay : INotifyPropertyChanged
    {
        ...
        public double DelayValue
        {
            ...
            set
            {
                ...
                if (delval == 0)
                {
                    PlayerService.Masterplayer.Config.Subtitles.Delay = 0;
                }
                else
                {
                    ...
                    PlayerService.Masterplayer.Config.Subtitles.Delay += finalval;
                }
                delval = value;
                OnPropertyChanged();
            }
        ...
        public static void Apply(string tagValue)
        {
            ...
            if (long.TryParse(tagValue, out long ms))
            {
                ...
                PlayerService.Masterplayer.Config.Subtitles.Delay += additionalTicks;
