...
* Play Audio in multiple-output devices at once and control individual output volumes easily.
* Apply Reverb to Audio Files inside the App. (Requires no external components)
* Create Playlists, Open Folders, Create Show Models.
* Save Progress of Videos you've watched.
* View History of Music you've listened to.
* Music Library groups all the music available on your PC.
* Play multiple FFmpeg Formats (mp4, mkv, mp3, wav, ogg, etc) without any external codecs
* Supports multiple codecs (H.264, H.265, etc)
* Edit Audio and Video Metadata for multiple files at once directly inside the app instantly.
* View Audio Artist, Album, Genre.
* Update Audio/Video covers easily.
